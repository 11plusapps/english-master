...
export default function SentenceStructurePracticeScreen({ route, navigation }) {
    ...
    setTimeout(() => {
      if (currentQuestionIndex < totalQuestions - 1) {
        ...
        const finalCorrect = answer === currentQuestion.correctAnswer
          ? correctAnswers + 1
          : correctAnswers;
        storage.savePracticeAttempt('sentence-structure', setId, finalCorrect, totalQuestions);
        setShowResults(true);
      }
    }, 3000);
  };
      ...
      <LinearGradient colors={set.gradient} style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.resultsContainer}>
            <Text style={styles.resultsTitle}>🏗️ Sentence Structure Complete!</Text>
            ...
            <View style={styles.performanceBox}>
              {percentage >= 80 && (
                <Text style={styles.performanceText}>🌟 Excellent! You build perfect sentences!</Text>
              )}
              {percentage >= 60 && percentage < 80 && (
                <Text style={styles.performanceText}>👏 Good work! Keep practicing!</Text>
              )}
              {percentage < 60 && (
                <Text style={styles.performanceText}>💪 Review sentence structure rules!</Text>
              )}
            </View>
  ...
  return (
    <LinearGradient colors={set?.gradient || ['#ef4444', '#dc2626']} style={styles.container}>
      <StatusBar barStyle="light-content" />

      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.header}>
          <Text style={styles.headerTitle}>🏗️ Sentence Structure</Text>
