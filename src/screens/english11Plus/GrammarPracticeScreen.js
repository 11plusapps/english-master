...
export default function GrammarPracticeScreen({ route, navigation }) {
    ...
    setTimeout(() => {
      if (currentQuestionIndex < totalQuestions - 1) {
        ...
        const finalCorrect = answer === currentQuestion.correctAnswer
          ? correctAnswers + 1
          : correctAnswers;
        storage.savePracticeAttempt('grammar', setId, finalCorrect, totalQuestions);
        setShowResults(true);
      }
    }, 3000);
  };
      ...
      <LinearGradient colors={set.gradient} style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.resultsContainer}>
            <Text style={styles.resultsTitle}>📖 Grammar Practice Complete!</Text>
            ...
            <View style={styles.performanceBox}>
              {percentage >= 80 && (
                <Text style={styles.performanceText}>🌟 Excellent! You're a grammar master!</Text>
              )}
              {percentage >= 60 && percentage < 80 && (
                <Text style={styles.performanceText}>👏 Good work! Keep practicing grammar rules!</Text>
              )}
              {percentage < 60 && (
                <Text style={styles.performanceText}>💪 Keep learning! Review grammar concepts!</Text>
              )}
            </View>
  ...
  return (
    <LinearGradient colors={set?.gradient || ['#a855f7', '#9333ea']} style={styles.container}>
      <StatusBar barStyle="light-content" />
