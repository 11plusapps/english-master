...
export default function VerbalReasoningPracticeScreen({ route, navigation }) {
    ...
    setTimeout(() => {
      if (currentQuestionIndex < totalQuestions - 1) {
        ...
        const finalCorrect = answer === currentQuestion.correctAnswer
          ? correctAnswers + 1
          : correctAnswers;
        storage.savePracticeAttempt('verbal-reasoning', setId, finalCorrect, totalQuestions);
        setShowResults(true);
      }
    }, 3000);
  };
      ...
      <LinearGradient colors={set.gradient} style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.resultsContainer}>
            <Text style={styles.resultsTitle}>🧩 Verbal Reasoning Complete!</Text>
            ...
            <View style={styles.performanceBox}>
              {percentage >= 80 && (
                <Text style={styles.performanceText}>🌟 Brilliant reasoning! You're a logical thinker!</Text>
              )}
              {percentage >= 60 && percentage < 80 && (
                <Text style={styles.performanceText}>👏 Good thinking! Keep practicing patterns!</Text>
              )}
              {percentage < 60 && (
                <Text style={styles.performanceText}>💪 Practice more word patterns and logic!</Text>
              )}
            </View>
  ...
  return (
    <LinearGradient colors={set?.gradient || ['#06b6d4', '#0891b2']} style={styles.container}>
      <StatusBar barStyle="light-content" />
